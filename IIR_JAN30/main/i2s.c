...
void i2s_example_init_std_simplex(i2s_chan_handle_t* a_tx_chan, i2s_chan_handle_t* a_rx_chan)
{
    ...
    i2s_std_config_t std_cfg = {
        ...
        .slot_cfg = I2S_STD_PHILIPS_SLOT_DEFAULT_CONFIG(I2S_DATA_BIT_WIDTH_32BIT, I2S_SLOT_MODE_STEREO),
        .gpio_cfg = {
            .mclk = GPIO_NUM_21,    // some codecs may require mclk signal, this example doesn't need it
    ...
    i2s_std_config_t rx_std_cfg = {
        ...
        .slot_cfg = I2S_STD_PHILIPS_SLOT_DEFAULT_CONFIG(I2S_DATA_BIT_WIDTH_32BIT, I2S_SLOT_MODE_STEREO),
        .gpio_cfg = {
            .mclk = GPIO_NUM_21, // ON PCB GPIO_NUM_21
            .bclk = GPIO_NUM_35, // ON PCB GPIO_NUM_35
            .ws   = GPIO_NUM_36, // ON PCB GPIO_NUM_36
            .dout = I2S_GPIO_UNUSED,
            .din  = GPIO_NUM_37, // ON PCB GPIO_NUM_37
            .invert_flags = {
                .mclk_inv = false,
                .bclk_inv = false,
                .ws_inv   = false,
