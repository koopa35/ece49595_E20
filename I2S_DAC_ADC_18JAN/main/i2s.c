...
#define EXAMPLE_STD_DIN_IO1         GPIO_NUM_14     // I2S data in io number
                                                    //
#define EXAMPLE_STD_BCLK_IO2        GPIO_NUM_11     // I2S bit clock io number
#define EXAMPLE_STD_WS_IO2          GPIO_NUM_12     // I2S word select io number
#define EXAMPLE_STD_DOUT_IO2        GPIO_NUM_13     // I2S data out io number
#define EXAMPLE_STD_DIN_IO2         GPIO_NUM_14     // I2S data in io number

#define EXAMPLE_BUFF_SIZE               2048


void i2s_example_read_task(i2s_chan_handle_t tx_chan, i2s_chan_handle_t rx_chan)
{
...
static void i2s_example_init_std_simplex(i2s_chan_handle_t* a_tx_chan, i2s_chan_handle_t* a_rx_chan)
{
